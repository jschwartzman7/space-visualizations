...
public class DomainColor extends PointSetAnimation<Lattice2DHelper<Euclidean2D>>{

    public DomainColor(Euclidean2D space, int frameRate, Function<Double[], Double[]> function, int pixelResolution){
        super(space, frameRate, function, new Lattice2DHelper<Euclidean2D>(space, pixelResolution));
    }
