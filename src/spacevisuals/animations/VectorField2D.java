...
public class VectorField2D extends PointSetAnimation<Euclidean2D> {
        ...
        public VectorField2D(Euclidean2D space, int frameSpeed, Function<Double[], Double[]> function, double pixelResolution){
        ...
        public void handleImage(Double[] input, Double[] output){
            ...
            //vector[0] /= m;
            //vector[1] /= m;
            double range = Math.min(space.xMaxClip-space.xMinClip, space.yMaxClip-space.yMinClip);
