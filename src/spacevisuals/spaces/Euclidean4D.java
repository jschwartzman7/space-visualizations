...
public class Euclidean4D extends AbstractSpace {
    ...
    public Euclidean3D space3D = Euclidean3D.Get();
    private static SingletonSpace<Euclidean4D> instance = new SingletonSpace<Euclidean4D>();
    ...
    public static Euclidean4D Get(){
        return instance.getOrCreateSpace(() -> new Euclidean4D());
    }
