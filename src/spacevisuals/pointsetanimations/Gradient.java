...
import spacevisuals.vectorfieldanimations.VectorField2D;
...
public class Gradient extends Animation2DSpace implements PointSetAnimation{
    ...
    public Gradient(Euclidean2D space, Function<double[], double[]> function){
        super(space, function);
        this.points = new LinkedList<double[]>();
        this.vectorField = new VectorField2D(space, function);
    }
    @Override
